...
public class ProductController implements ProductControllerInterface {
    ...
    /**
     * Поиск всех товаров
     * @return {@link ts.tsc.system.services.implementations.BaseServiceImplementation#findAll(JpaRepository)}
     */
    @Override
     ...
     * @return {@link ts.tsc.system.services.implementations.NamedServiceImplementation#findByName(String, NamedRepository)}
     */
    @Override
     ...
     * @return {@link ts.tsc.system.services.implementations.BaseServiceImplementation#findById(Object, JpaRepository)}
     */
    @Override
    @GetMapping(value = "/{id}")
     ...
     * @return {@link ts.tsc.system.services.implementations.BaseServiceImplementation#save(Object, JpaRepository)}
     */
    @Override
    @PostMapping(value = "/")
     ...
     * @return {@link ts.tsc.system.services.implementations.ProductServiceImplementation#findByCategory(String, ProductRepository)}
     */
    @Override
